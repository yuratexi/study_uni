        ...
        switch (n) {  //q=問題,a1=答え(1つめ),a2=答え(2つめ)...,k=答えの数
            ...
            case 1:
                ...
                switch (m) {
                    ...
                    case 19: q = `SSHトンネルの特徴として正しいものはどれか？<br>A.VPNに比べて必ずしも安全ではない<br>B.ファイアウォールを超えて通信できない<br>C.特定のポートに限定される<br>D.別のアプリケーションの通信をSSHのポートで安全に転送できる`; a1 = `C`; k = 1; break;
                    ...
                    //FQDN(Fully Qualified Domain Name)とは何かを簡潔に説明せよ。
                    //なぜNAPTでは1つのグローバルIPで複数の端末がインターネットに接続できるのか、仕組みを説明せよ【ヒント:ポート番号】
                }
                break;
